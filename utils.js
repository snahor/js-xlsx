// TODO move to ssf.js, this is just a copycat from SSF
...
function safe_format_cell(cell, v) {
  if (cell.z !== undefined) try {
    ...
    return (cell.w = format(cell.z, v));
  } catch (e) {}
  if (!cell.XF) return v;
  try {
    //return (cell.w = SSF.format(cell.XF.ifmt || 0, v));
    return (cell.w = format(cell.XF.ifmt || 0, v));
  } catch (e) {
    return '' + v;
  }
}
